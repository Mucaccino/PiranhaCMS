...
WriteLiteral(@">
        ...
        $(document).ready(function () {
            ...
            $('#btnGenerate').click(function () {
                $.getJSON(sitemanager + ""/settings/apikey"", function (data) {
...
WriteAttribute("href", Tuple.Create(" href=\"", 6006), Tuple.Create("\"", 6089)
            
            #line 139 "..\..\Areas\Manager\Views\Settings\User.cshtml"
, Tuple.Create(Tuple.Create("", 6013), Tuple.Create<System.Object, System.Int32>(Url.Action("generatepassword", "settings", new { @id = Model.Password.Id })
